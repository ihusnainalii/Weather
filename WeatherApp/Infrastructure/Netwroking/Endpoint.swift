...
/// All required data for calling an endpoint
...
extension Requestable {
    ...
    func url(with config: NetworkConfigurable) throws -> URL {
        ...
        let baseURLAndLocalAndVersion = (baseURL.last != "/" ? baseURL + "/" : baseURL) + "\(config.rootOfEndpoint)/\(config.version)"
        let endpoint = isFullPath ? path : baseURLAndLocalAndVersion.appending(path)
